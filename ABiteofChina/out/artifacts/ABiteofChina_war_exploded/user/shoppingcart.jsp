...
<meta name="keywords" content="中国八大菜系特卖网, shopping cart, free template, ecommerce, online shop, website templates, CSS, HTML" />
<meta name="description" content="中国八大菜系特卖网, Shopping Cart, online store template " />
...
<div id="templatemo_wrapper">
	...
	<div id="templatemo_header">
    	<div id="site_title"><h1><a href="${pageContext.request.contextPath }/index.jsp">舌尖上的中国 - 中国八大菜系特卖网</a></h1></div>
        <div id="header_right">
        	<p>
	        <c:if test="${!empty user }">
	        	...
	        	<table width="680px" cellspacing="0" cellpadding="5">
	                      ...
	                      <c:if test="${!empty user }">
		                      <c:forEach items="${shoppingCart.shoppingitems}" var="item">
									<tr>
			                        	<td>
											<a href="${pageContext.request.contextPath }/MultipartUserProductServlet?op=findProductByPid&pid=${item.pid}">
    ...
    <div id="templatemo_footer">
		    Copyright (c) 2018 <a href="#">舌尖上的中国</a> | <a href="#">版权所有</a>
    </div> 
