...
<script type="text/javascript">
    function isCategoryNameAvailable() {
        ...
        /*var url = "/ABiteofChina/admin/AjaxServlet?ajax=isCategoryNameAvailable&cname=" + cname.value;
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0"
					...
					<tr>
						...
						<td width="80%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="left">
 							 <span style="color:red">*</span> 
						
						<input type="text" name="cname" onblur="isCategoryNameAvailable()"/>
                            <span id="message" class="STYLE6">
