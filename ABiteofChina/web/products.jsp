        ...
        <div id="templatemo_main">
            ...
            <div id="content" class="float_r">
                ...
                <c:forEach items="${page.records}" var="product" varStatus="vs">
                    <c:choose>
                        <c:when test="${8 == product.cid}">
                            <div style="width: 620px" class="${vs.index % 3 != 2?'product_box':'product_box no_margin_right' }">
                            <a href="${pageContext.request.contextPath }/MultipartUserProductServlet?op=findProductsByName&pname=${product.pname}">
                                <img src="${pageContext.request.contextPath }/${product.imgurl}" width="620" height="300" alt=""
                                     title="${product.pname }"/>
                            </a>
                            <p>${product.pname}</p>
                            </div>
                        ...
                        <c:otherwise>
                            <div class="${vs.index % 3 != 2?'product_box':'product_box no_margin_right' }">
                                <a href="${pageContext.request.contextPath }/MultipartUserProductServlet?op=findProductByPid&pid=${product.pid}">
                            ...
                            <table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="49">
                                        <div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/MultipartUserProductServlet?op=findProductByCid&cid=${page.records[0].cid}&num=1">首页</a>
											</span>
                                        </div>
                                    </td>
                                    <td width="49">
                                        <div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/MultipartUserProductServlet?op=findProductByCid&cid=${page.records[0].cid}&num=${page.prevPageNum}">上一页</a>
											</span>
                                        </div>
                                    </td>
                                    <td width="49">
									    ...
									    <div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/MultipartUserProductServlet?op=findProductByCid&cid=${page.records[0].cid}&num=${page.nextPageNum}">下一页</a>
											</span>
										</div>
                                        </span>
                                    </td>
                                    <td width="49">
                                        <div align="center">
                                            <span class="STYLE22">
                                                <a href="${pageContext.request.contextPath }/MultipartUserProductServlet?op=findProductByCid&cid=${page.records[0].cid}&num=${page.totalPageNum }">尾页</a></span>
                                        </div>
                                    </td>
...
<script type="text/javascript">
    ...
    function jump() {
        ...
        var param = "&cid=${requestScope.cid}";
        /*//var param = document.getElementById('keywordCid').value ;*/
        window.location.href = "${pageContext.request.contextPath }/MultipartUserProductServlet?op=findProductByCid&num=" + num +param;
