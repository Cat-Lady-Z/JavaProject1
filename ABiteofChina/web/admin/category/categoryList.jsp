		...
		<tr>
			<td height="30">
				<table width="100%" border="0" cellpadding="0"
					   cellspacing="1" bgcolor="#a8c7ce">
					<c:forEach var="category" items="${page.records}" varStatus="status">
					<tr>
						<td width="4%" height="20" bgcolor="FFFFFF" class="STYLE10"><div
								align="center">
							<input type="checkbox" name="cid" value="${category.cid}"/>
						</div>
						</td>
						<td width="10%" height="20" bgcolor="FFFFFF" class="STYLE6"><div
							...
							<a href="${pageContext.request.contextPath}/admin/CategoryServlet?op=deleteCategory&cid=${category.cid}">删除</a>
						</div>
						</td>
					</tr>
					</c:forEach>
							...
							<table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
								<tr>
									<td width="49">
										<div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/admin/CategoryServlet?op=findAllCategoryByPage&num=1">首页</a>
											</span>
										</div>
									</td>
									<td width="49">
										<div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/admin/CategoryServlet?op=findAllCategoryByPage&num=${page.prevPageNum}">上一页</a>
											</span>
										</div>
									</td>
									<td width="49"><span class="STYLE22">
									    <div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/admin/CategoryServlet?op=findAllCategoryByPage&num=${page.nextPageNum}">下一页</a>
											</span>
										</div>
									</td>
									<td width="49">
										<div align="center">
											<span class="STYLE22"><a href="${pageContext.request.contextPath }/admin/CategoryServlet?op=findAllCategoryByPage&num=${page.totalPageNum }">尾页</a></span>
										</div>
									</td>
