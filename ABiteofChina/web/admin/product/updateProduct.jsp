...
<html>
	...
	<body>
	 <form method="post" action="${pageContext.request.contextPath }/admin/MultipartProductServlet?op=updateProduct" enctype="multipart/form-data">
			...
			<td height="30">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
                        ...
                        <td width="67%">
                            <div align="right">
                                <a href="${pageContext.request.contextPath}/admin/product/productList.jsp?num=1"><input type="button" value="返回"/></a>
                            </div>
                        </td>
						<td width="67%">
						   <div align="right">
